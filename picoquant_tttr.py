##########################################################################
# WARNING: Just a snapshot; don't use this version!
# Also, don't run this file. It's just a dependency to be imported by
# `run_me_to_generate_figures.py`
#
# If you want to use this for anything else, get the most recent version at:
# https://github.com/AndrewGYork/tools/blob/master/picoquant_tttr.py
##########################################################################
import os
import struct
import numpy as np
